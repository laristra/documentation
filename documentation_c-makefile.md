# How to
How to use GitHub, Travis CI, CodeCov, SonarQube, Doxygen, and Make using c with [c-makefile repository](https://github.com/laurelmcintyre/c-makefile) as example -- refer to [documentation_python.md](https://github.com/laurelmcintyre/documentation/blob/gh-pages/instructions_python.md) for more detailed instructions
