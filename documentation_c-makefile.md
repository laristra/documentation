# How to
How to use GitHub, Travis CI, CodeCov, SonarQube, Doxygen, and Make using c with [example c-makefile repository](https://github.com/laurelmcintyre/c-makefile)
...
Next, in the .travis.yml file, change these existing script lines:
