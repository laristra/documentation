...
* `travis encrypt-file ./deploy` tells travis to encrypt the private deploy key -- travis must be installed on the local machine and then contains a list of commands (run `travis --help` to see them)
