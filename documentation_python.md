...
These three settings are the minimum configuration, but there are more optional settings that you can add to specify the configuration of CodeCov for your project.
